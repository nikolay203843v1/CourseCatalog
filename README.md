...
авторизации. Интерфейс реализован на XML/ViewBinding по предоставленным
макетам.
...
По условиям задания поиск, фильтр, регистрация, восстановление пароля,
детальная страница курса и экран аккаунта не содержат бизнес-логики.
